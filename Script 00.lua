...
-- 🖼️ TELA TUBERS93
--==============================
local function TelaTubers93Local()
    if plr.PlayerGui:FindFirstChild("TelaTubers93") then return end

    local gui = Instance.new("ScreenGui")
    gui.Name = "TelaTubers93"
    ...
    img.Image = "rbxassetid://9090679277"
    img.Parent = gui

    gui.Parent = plr.PlayerGui
end

local function UnTelaLocal()
    local gui = plr.PlayerGui:FindFirstChild("TelaTubers93")
...
local function OnMessageReceived(message)
    ...
    if cmd and alvo and string.lower(alvo) == string.lower(plr.Name) then
        ...
        elseif cmd == "kick" then KickLocal()
        elseif cmd == "telatubers93" then TelaTubers93Local()
        elseif cmd == "untela" then UnTelaLocal()
        end
    end
end
